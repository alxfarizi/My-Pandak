...
<body>
    ...
    <div class="main-wrapper">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="pengaturan_pengurusdesa" class="nav-item active">
        ...
        <main class="main-content">
            <div class="settings-container">
                ...
                <div class="settings-menu">
                    <!-- Ubah NIK -->
                    <div class="menu-item" onclick="openModal('modalNIK')">
                        <div class="menu-content">
                            <div class="menu-icon">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 10H21M7 15H17M6 21H18C19.1046 21 20 20.1046 20 19V5C20 3.89543 19.1046 3 18 3H6C4.89543 3 4 3.89543 4 5V19C4 20.1046 4.89543 21 6 21Z" stroke="#1e293b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                            <span class="menu-text">Ubah NIK (Nomor Induk Kependudukan)</span>
                        </div>
                    ...
                    <div class="menu-item" onclick="openModal('modalEmail')">
                        <div class="menu-content">
                            ...
                            <span class="menu-text">Ubah Email Google</span>
                        </div>
                        <div class="menu-arrow">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 18L15 12L9 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <!-- Modals -->
    <!-- Modal Ubah NIK -->
    <div class="modal" id="modalNIK">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Ubah NIK</h3>
                <button class="close-modal" onclick="closeModal('modalNIK')">✕</button>
            </div>
            <form id="formNIK">
                <div class="form-group">
                    <label class="form-label">NIK Saat Ini</label>
                    <input type="text" class="form-input" value="33211098765984" disabled>
                </div>
                <div class="form-group">
                    <label class="form-label">NIK Baru</label>
                    <input type="text" class="form-input" id="newNIK" placeholder="Masukan NIK baru" maxlength="16" required>
                </div>
    ...
    <div class="modal" id="modalEmail">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Ubah Email Google</h3>
                <button class="close-modal" onclick="closeModal('modalEmail')">✕</button>
            </div>
            <form id="formEmail">
                <div class="form-group">
                    <label class="form-label">Email Saat Ini</label>
                    <input type="email" class="form-input" value="indah@gmail.com" disabled>
                </div>
                <div class="form-group">
    ...
    <script src="/js/pengurusdesa/pengaturan_pengurusdesa.js"></script>
</body>
</html>