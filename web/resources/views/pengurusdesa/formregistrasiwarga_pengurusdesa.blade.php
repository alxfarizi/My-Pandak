...
<head>
    ...
    <title>Tambah Akun Warga - My Pandak</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/css/pengurusdesa/formregistrasiwarga_pengurusdesa.css">
</head>
<body>
    <!-- Header -->
    <header class="header">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="header-content">
                    <h2 class="page-title">Tambah Akun Warga</h2>
                </div>
            </div>
    ...
    <script src="/js/pengurusdesa/formregistrasiwarga_pengurusdesa.js"></script>
</body>
</html>