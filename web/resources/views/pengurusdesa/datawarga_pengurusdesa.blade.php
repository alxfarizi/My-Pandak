...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="empty-state" id="emptyState" style="display: none; text-align: center; padding: 40px;">
                ...
                <a href="adddatawarga_pengurusdesa" class="btn-add" style="display: inline-block; padding: 10px 20px; background-color: #4361EE; color: white; text-decoration: none; border-radius: 8px; font-weight: 500;">
    ...
    <script src="/js/pengurusdesa/datawarga_pengurusdesa.js"></script>
</body>
</html>