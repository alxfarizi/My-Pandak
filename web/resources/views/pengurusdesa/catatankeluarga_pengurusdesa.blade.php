...
<body>
    ...
    <div class="main-wrapper">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="catatankeluarga_pengurusdesa" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <div class="empty-state" id="emptyState" style="display: none; text-align: center; padding: 40px;">
                ...
                <p style="margin-bottom: 20px; color: #666;">Silakan tambahkan catatan keluarga terlebih dahulu untuk melihat tabel.</p>
                <a href="addcatatankeluarga_pengurusdesa" class="btn-add" style="display: inline-block; padding: 10px 20px; background-color: #4361EE; color: white; text-decoration: none; border-radius: 8px; font-weight: 500;">
            ...
            <div class="table-container" id="tableContainer" style="display: none;">
                ...
                <table class="data-table">
                    ...
                    <tbody id="tableBody">
                        <tr onclick="window.location.href='addcatatankeluarga_pengurusdesa.html'">
                            <td>1</td>
                            <td>Mawar 1</td>
    ...
    <script src="/js/pengurusdesa/catatankeluarga_pengurusdesa.js"></script>
</body>
</html>