...
<head>
    ...
    <title>Akun Pengurus Desa - My Pandak</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/css/pengurusdesa/registrasitabelpengurus_pengurusdesa.css">
</head>
<body>
    <!-- Header -->
    <header class="header">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="header-content">
                    <h2 class="page-title">Akun Pengurus Desa</h2>
                    <p class="page-subtitle">Daftar akun pengurus desa yang telah terdaftar</p>
                </div>
            </div>
            ...
            <div class="action-bar">
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari nama pengurus atau jabatan...">
                </div>
            </div>

            <!-- Table Container -->
            <div class="table-container">
                <table class="data-table" id="pengurusTable">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Desa Wisma</th>
                ...
                <div class="empty-state" id="emptyState" style="display: none;">
                    ...
                    <p>Belum ada data pengurus desa</p>
    ...
    <div class="modal" id="detailModal">
        <div class="modal-content modal-detail">
            <div class="modal-header">
                <h3 class="modal-title">Detail Pengurus Desa</h3>
    ...
    <div class="modal" id="registrationModal">
        <div class="modal-content modal-form">
            <div class="modal-header">
                <h3 class="modal-title">Tambah Akun Pengurus Desa</h3>
                ...
                <form class="registration-form" id="registrationForm">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nik" name="nik" required placeholder="Masukan NIK 16 digit" maxlength="16">
                        </div>
    ...
    <script src="/js/pengurusdesa/registrasitabelpengurus_pengurusdesa.js"></script>
</body>
</html>