...
<head>
    ...
    <link rel="stylesheet" href="/css/warga/login_warga.css">
    <style>
        /* Modal Styles */
        .modal {
            display: none;
...
<body>
       ...
       <section class="brand-section">
        ...
        <section class="login-section">
            <div class="login-card">
                ...
                <!-- Tab Admin/Warga -->
                <div class="role-tabs">
                    <button class="role-tab" onclick="window.location.href='/pengurusdesa/login_pengurusdesa'">Pengurus</button>
                    <button class="role-tab active">Warga</button>
                </div>

                <!-- Form login -->
                <form id="loginForm">
                    <div class="input-group">
                        <label class="input-label" for="username">NIK / Akun Google</label>
                        <input type="text" id="username" class="input-field" placeholder="Masukkan NIK atau email" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div style="text-align: center; color: #1e293b;">
                <p style="margin-bottom: 20px; line-height: 1.6;">
                    Jika Anda mengalami kendala saat masuk atau lupa NIK, silakan hubungi Sekretariat Desa Pandak.
                </p>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; margin-bottom: 20px;">
                    <p style="font-weight: 600; margin-bottom: 8px;">Kontak Pengurus Desa:</p>
                    <p style="margin-bottom: 4px;">📞 WhatsApp: 0812-xxxx-xxxx</p>
                    <p style="margin-bottom: 4px;">📧 Email: admin@pandak.desa.id</p>
                    <p>🏢 Alamat: Jl. Raya Pandak No. 1</p>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="formForgotPassword">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-input" id="forgotEmail" placeholder="contoh: budi@gmail.com" required>
                </div>
    ...
    <script src="/js/warga/login_warga.js"></script>
</body>
</html>