...
<body>
    ...
    <div class="main-wrapper">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="datakeluarga_warga" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <div class="empty-state" id="emptyState" style="display: none; text-align: center; padding: 40px;">
                ...
                <p style="margin-bottom: 20px; color: #666;">Silakan tambahkan data keluarga Anda (hanya satu kali).</p>
                <a href="adddatakeluarga_warga" class="btn-add" id="btnAddEmpty" style="display: inline-block; padding: 10px 20px; background-color: #4361EE; color: white; text-decoration: none; border-radius: 8px; font-weight: 500;">
            ...
            <div class="table-container" id="tableContainer" style="display: none;">
                <div class="table-header-actions" style="margin-bottom: 15px; display: flex; justify-content: flex-end;">
                     <a href="adddatakeluarga_warga" class="btn-add" id="btnAddTable" style="display: inline-block; padding: 10px 20px; background-color: #4361EE; color: white; text-decoration: none; border-radius: 8px; font-weight: 500;">
                        <img src="/assets/icons/plus.svg" alt="Add" style="width: 20px; height: 20px; vertical-align: middle; margin-right: 5px;">
                        Tambah Data
                    </a>
                </div>
    ...
    <script src="/js/warga/datakeluarga_warga.js"></script>
</body>
</html>