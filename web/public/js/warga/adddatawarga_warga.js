...
function goBack() {
    window.location.href = 'datawarga_warga';
}
...
function saveData() {
    ...
    // Simpan ke localStorage (Gunakan key yang berbeda untuk Warga)
    const existingData = JSON.parse(localStorage.getItem('dataWargaWarga') || '[]');
    existingData.push(formData);
    localStorage.setItem('dataWargaWarga', JSON.stringify(existingData));
