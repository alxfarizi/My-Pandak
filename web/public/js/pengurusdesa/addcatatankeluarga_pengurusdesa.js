...
function goBack() {
    window.location.href = 'catatankeluarga_pengurusdesa';
}
...
function loadTableData(tableIndex, data) {
    ...
    // Load text inputs
    const textFields = ['namaAnggota', 'tglLahir', 'pekerjaan'];
...
function saveData() {
    ...
    const existingData = JSON.parse(localStorage.getItem('dataCatatanKeluarga') || '[]');
    existingData.push(formData);
    localStorage.setItem('dataCatatanKeluarga', JSON.stringify(existingData));
