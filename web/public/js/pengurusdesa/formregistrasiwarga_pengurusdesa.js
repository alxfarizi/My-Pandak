...
registrationForm.addEventListener('submit', (e) => {
    ...
    const emailExists = wargaData.some(w => w.email === emailGoogle);
    if (emailExists) {
    ...
    const newWarga = {
        ...
        role: 'warga',
        password: password // In real app, don't store plain password
    };
    
    // Save to sessionStorage for validation page
    sessionStorage.setItem('tempWargaData', JSON.stringify(newWarga));
    
    // Redirect to validation page
    window.location.href = 'validasiregistrasiakunwarga_pengurusdesa';
});
